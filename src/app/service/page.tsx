...
const FAQS = [
  ...
  },
  {
    ...
    a: "公開直後の動作確認までは制作費に含みます。それ以降は月額の固定契約を設けておらず、状況に応じて都度ご相談・お見積りのうえ対応します。",
  },
  {
    q: "写真・動画だけの依頼はできますか？",
    a: "可能です。WEB制作・アプリ制作と組み合わせる場合は、セット割引価格（半額）が適用されます。ドローン撮影も同様に半額となります。",
  },
  {
    q: "支払い条件について教えてください",
  ...
  {
    q: "契約後に、お客様都合でキャンセルする場合はどうなりますか？",
    a: "着手金のお支払い後にキャンセルされる場合、その時点までの作業内容に応じて、実費・工数分を差し引いたうえで残額を返金いたします。ドローン撮影のキャンセルについては、ドローン撮影ページの規定が優先されます。",
  },
  {
  ...
  {
    q: "お問い合わせから、どのくらいで返信がありますか？",
    a: "営業日1〜2日以内にご連絡いたします。",
  },
];
        ...
        <div className="wrap">
          ...
          <div className="grid-3">
            ...
            <ServiceCard
              ...
              eyebrow="含まれること"
              items={["LINEログインなど、使い慣れた手段での認証", "管理画面から自分で更新できる設計", "公開直後の動作確認、その後は状況に応じたフォロー"]}
              icon={AREA_ICONS.app}
              accent="var(--system)"
              revealDelay={140}
            />
