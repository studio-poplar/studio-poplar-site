        ...
        <div className="wrap">
          <Reveal>
            <AboutBlock
              ...
              body="事業を始めたばかりの頃は、伝えたいことがたくさんあるのに、言葉にしようとすると、どれも少しずつ違ってしまう。「雰囲気はこう」「これだけは譲れない」といった、輪郭の曖昧な感覚こそ、その事業らしさそのものだと考えています。Studio Poplarは、まず話を聞くところから始めます。その場で出てきた言葉を一緒に整理し、サイトやアプリ、写真・映像へと置き換えていく。頭の中にあるものと、画面に映るものとの距離を、できるだけ小さくすることが、私たちの仕事です。"
            />
          </Reveal>
        </div>
      </section>
