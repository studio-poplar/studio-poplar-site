...
export const WEB_OPTIONS: WebOption[] = [
  { id: "domain", label: "独自ドメインの取得", addPrice: 10000 },
  { id: "booking", label: "予約システム", addPrice: 10000 },
  { id: "ec", label: "ECカート機能", addPrice: 10000 },
  { id: "cms", label: "自分で更新できるCMS導入", addPrice: 10000 },
];
